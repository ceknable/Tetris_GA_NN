...
def TETRIS(TInput):
    ''' This function plays the game of Tetris with moves as the input and the
    current game board and status as the output'''    
    
    if __name__ == "__main__":
        # Create an instance of Tetris
        env = gym.make("tetris_gymnasium/Tetris", render_mode="human")
        env.reset(seed=42) # change to randint generator
